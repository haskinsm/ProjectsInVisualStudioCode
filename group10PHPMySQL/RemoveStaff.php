<!-- 
    Purpose of Script: Remove Employees
...
<h4>Select Employee: </h4>
        <!--Goes to RemoveStaffNext.php page if details correctly entered-->
        <form action="RemoveStaffNext.php" method="post" name="signupform" id="signupform">            
            <table>
            <tr>  
            <td>
