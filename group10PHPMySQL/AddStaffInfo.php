...
<body>
	...
	<br>
        ...
        <?php include 'StaffMenuBar.php';?> <!-- Imports code for staff menu bar from another php file-->
        <br>
           ...
           <div class="col-lg-9 col-md-9">   
                 ...
                 <form method="post" action="StaffInfoCode.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <?php if ($update){ ?>
				<input type="submit" id="updateStaffInfoBtn" name="updateStaffInfoBtn" value="Update my details">
			    <?php }
			    else { ?>
                            	<input type="submit" id="addStaffInfoBtn" name="addStaffInfoBtn" value="Add my details">
			    <?php } ?>
                        </div>
                    </div>
