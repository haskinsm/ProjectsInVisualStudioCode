<!-- 
    Purpose of Script: Adjust Pricing of Items
...
<head>
    ...
    <title> Adjust Item Pricing </title>
...
<h4>Select Item: </h4>
        ...
        <form action="AdjustItemPricingNext.php" method="post" name="signupform" id="signupform">            
            <table>
            <tr>  
            <td>
