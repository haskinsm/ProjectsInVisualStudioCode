<!--
    ...
    Edited by: Harry O'Brien 9/3/21
-->
                ...
                <td class="dropdown" >
                    <select name="bookingID">
                        <?php
                            ...
                            $sqlQ2 = "SELECT Booking_ID, Event_Start_Date, Event_End_Date FROM Bookings Where Event_End_Date >= CURRENT_DATE() AND Business_Email = '$email' ORDER BY Event_Start_Date ASC";
    ...
    <table>
        ...
        <?php
            if( $iDEntered){
                ...
                $sql = "SELECT Booking_ID, Event_Start_Date, Event_End_Date, Event_Start_Time, Event_End_Time, Delivery_Status, Collection_Status FROM Bookings Where Booking_ID ='$selectedBookingID' ";
