...
<body>
    ...
    <form action="CustomerHomePage.php" > <!-- Currently does not check if valid password & email combo, just redirects as long as something is entered -->
    <!--
    ...
    <div class="imgcontainer">
        <img src="images/CustAvatars.png" alt="Avatar" class="avatar"> 
    </div>
