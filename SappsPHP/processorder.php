...
<body>
    ...
    $totalqty = $cashelqty + $cheddarqty + $gubeenqty + $durrusqty;

    if($totalqty == 0 ){ //Should prob check if <0
        echo "<font color = red>";
        echo "You did not order anything on the previous page! <br/>";
        echo "</font>";
        exit; //Exits the entire PHP Script //Techincally dont need the else statement so
    }
    else{
